...
int usermapped_receivenb_softint(endpoint_t src, message *m_ptr, int *status_ptr);
...
int usermapped_receivenb_syscall(endpoint_t src, message *m_ptr, int *status_ptr);
...
int usermapped_receivenb_sysenter(endpoint_t src, message *m_ptr, int *status_ptr);
