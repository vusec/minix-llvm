...
{				/* Test fcntl flags. */
  ...
  Fstat(tube[1], &st2);
  Time(&time2);
  if (st1.st_atime < time1) me(26);
  if (st1.st_ctime < time1) me(27);
  if (st1.st_mtime < time1) me(28);
  if (st1.st_atime > time2) e(29);
  if (st1.st_ctime > time2) e(30);
  if (st1.st_mtime > time2) e(31);
  if (st2.st_atime < time1) me(32);
  if (st2.st_ctime < time1) me(33);
  if (st2.st_mtime < time1) me(34);
